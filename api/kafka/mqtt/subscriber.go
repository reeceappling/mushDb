...
var subConnectHandler mqtt.OnConnectHandler = func(client mqtt.Client) {
	fmt.Println("Connected to MQTT Broker")
}

var subConnectLostHandler mqtt.ConnectionLostHandler = func(client mqtt.Client, err error) {
...
func main() {
	...
	opts.OnConnect = subConnectHandler
	opts.OnConnectionLost = subConnectLostHandler
