...
// TO RUN: remove the first space in goland on the next line and click the run button
...
func main() {
	...
	const header = `// Code generated by goGenerator; DO NOT EDIT. To regenerate: (remove the first space in goland)
