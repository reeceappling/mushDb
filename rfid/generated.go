...
func mainCollMap(name string) (item MainCollectionItem, exists bool) {
	switch name {
	case "bag": return &Bag{}, true
	case "fruit": return &Fruit{}, true
	case "fruitingChamber": return &FruitingChamber{}, true
	case "jar": return &GrainJar{}, true
	case "lcSyringe": return &LcSyringe{}, true
	case "lc": return &LiquidCulture{}, true
	case "mss": return &MSS{}, true
	case "plate": return &Plate{}, true
	case "plug": return &PlugsJar{}, true
	case "slant": return &Slant{}, true
	case "sporePrint": return &SporePrint{}, true
	case "swab": return &SporeSwab{}, true
	case "stasisTube": return &StasisTube{}, true
